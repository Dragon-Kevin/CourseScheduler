...
public class Course_Scheduler {
    ...
    {
        //***temp code needs to stay until data file contains professor ids and
        //   parser correctly fills out the front end data structures with this
        //   id data or whatever data is the primary key
        Teacher teacher;
     ...
     * @param courses 
     */
    public static void storeClassrooms(List<Classroom> classrooms)
    {      
        Classroom room;
        Iterator itr = classrooms.iterator();
        while(itr.hasNext())
        {
            room = (Classroom)itr.next();
            db.addClassroom(room);
        }
    }    
